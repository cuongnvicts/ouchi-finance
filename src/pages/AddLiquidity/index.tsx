    ...
    return noLiquidity ? (
      <AutoColumn gap="20px">
        <LightCard mt="20px" borderRadius="20px">
          <RowFlat style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
            <CustomText>{currencies[Field.CURRENCY_A]?.symbol + '/' + currencies[Field.CURRENCY_B]?.symbol}</CustomText>
      ...
      <AutoColumn gap="20px">
        <RowFlat style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
          <CustomText>{liquidityMinted?.toSignificant(6)}</CustomText>
      ...
      <AppBody>
        ...
        <Wrapper>
          ...
          <AutoColumn gap="20px">
            ...
            />
            <ColumnCenter>
              <Plus size="30" color={'#42B7A0'} fontWeight={600} />
            </ColumnCenter>
            <CurrencyInputPanel
              ...
              <>
                <LightCard padding="0px" borderRadius={'20px'}>
                  <RowBetween padding="1rem">
                    <TYPE.subHeader fontWeight={500} fontSize={14} color={'#9FA2B4'}>
                      {noLiquidity ? t('initialPricesAndPool') : t('pricesAndPool')}
                    </TYPE.subHeader>
                  </RowBetween>{' '}
                    ...
                    <RowBetween>
                      {approvalA !== ApprovalState.APPROVED && (
                        <ButtonPrimary
                          ...
                          style={approvalB !== ApprovalState.APPROVED ? { marginRight: 10 } : undefined}
                        >
                          {approvalA === ApprovalState.PENDING ? (
                      ...
                      {approvalB !== ApprovalState.APPROVED && (
                        <ButtonPrimary
                          ...
                          style={approvalA !== ApprovalState.APPROVED ? { marginLeft: 10 } : undefined}
                        >
                          {approvalB === ApprovalState.PENDING ? (
